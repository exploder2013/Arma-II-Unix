...
bool d3Console::initilize(rManager * rMGR, HINSTANCE hInst)
{
	...
	this->rMGR = rMGR;
	this->rMGR->createFont( "sans-serif", 16, 8, &this->titleFont );
	this->rMGR->createFont( "Lucida Console", 14, 8, &this->textFont );
	this->rMGR->createFont("Tahoma", 16, 6, &this->carrotFont);
